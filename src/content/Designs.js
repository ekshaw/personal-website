const Designs = [
  {
    ...
    overview: (
      <div>
        The YHWH Apparel website project explores a brand that empowers people to express their
        identity through their apparel. Profits generated from sales are dedicated to supporting
        various partnerships, embodying the brand's commitment to giving back and making a positive
        impact. The core audience of YHWH Apparel largely comprises students and young adults,
        reflecting a vibrant and socially conscious demographic eager to connect with faith-infused
        fashion. This project encompasses not only a website overhaul, but also a comprehensive
        rebranding strategy, introducing a new logo, typography, iconography, and color palette.
      </div>
    ),
    problem: (
      <div>
        We identified that the existing YHWH Apparel brand struggles to showcase the brand's ethos.
        A lack of visual consistency dilutes the brand's message, impeding engagement with the
        intended audience. Furthermore, the website's usability issues, especially in their mobile
        experience and disjointed store page hosted on Storenvy, detract from the user experience.
      </div>
    ),
    solution: (
      <div>
        We aimed to redesign the website with the new visual identity including consistent
        typography, color palette, iconography, and photography guidelines, craft a website that
        enables visitors to explore YHWH Apparel's offerings end-to-end with an independent payment
        platform, and prioritize the site's mobile interface, to provide a seamless experience for
        users across devices.
      </div>
    ),
    question: (
      <div>
        How might we help users understand the mission, purpose, and impact of YHWH's products?
      </div>
    ),
    research: (
      <div>
        A large focus was to map a user's journey through a shopping experience. We analyzed
        different online shopping platforms to understand the conventional structure and identified
        the features that were applicable to our platform. With regards to the mobile interface, we
        researched effective responsive designs strategies and how certain features might fit into
        our website.
      </div>
    ),
    ideation: (
      <div>
        With our findings, we brainstormed different features for both the mobile and desktop
        interface and ways to direct the user flow. Aesthetically, the main aspect that was taken
        into consideration was the use of the color palette across the website. With different
        iterations utilizing the primary and secondary colors, we found that using the more neutral
        colors allowed for less conflict with the images which varied depending on the marketing
        campaign, seasonality, and the product itself.
      </div>
    ),
    ...
    features: [
      [
        'brand guidelines',
        <div>
          The new visual identity included a new logo along with consistent typography, color
          palette, iconography, and photography guidelines that mirror the brand's fusion of
          spirituality and style, enhancing recognition and resonating with the core audience.
        </div>,
      ...
      [
        'mobile interface',
        <div>
          Prior to the launch, the mobile interface was non-existent, taking the desktop interface
          and shrinking it down. With the new interface, a mobile navigation bar was added, in
          addition to features like scrolling cards, toggle buttons, and easily clickable social
          media icons.
        </div>,
        require('../images/yhwh-05.png')
      ],
      [
        'independent shopping platform',
        <div>
          An important feature of the product was a shopping platform. The shopping process was
          designed so the user could discover and choose to shop designs through the Designs Page or
          navigate directly to the Shop Page. Uniform products pages were created to easily populate
          with new product additions and were implemented with proper feedback to actions. The
          checkout process uses a standard flow to fill out information and easy ways to edit your
          cart and checkout.
        </div>,
  ...
  },
  {
    ...
    features: [
      ...
      [
        ...
        <div>
          To expand the podcast's reach and engagement, we explored potential merchandise ideas that
